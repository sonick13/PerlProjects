...
# Last Change       - Wed 17 Apr 15:21:58 BST 2019
...
# This is effectively like the shell while read loop, but more involved.
while(<file>){
	...
	# Check for and set the correct grammar for both hour and minutes.
